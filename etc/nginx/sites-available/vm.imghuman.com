server {
    ...
    server_name vm.imghuman.com *.vm.imghuman.com;
...
server {
    ...
    ssl on;
    ssl_certificate /etc/nginx/ssl/imghuman.com.pem;
    ssl_certificate_key /etc/nginx/ssl/imghuman.com.key;
	...
	access_log /var/log/nginx/vm.imghuman.com.access.log;
	error_log /var/log/nginx/vm.imghuman.com.error.log debug;
