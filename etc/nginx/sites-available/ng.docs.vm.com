server {
    ...
    server_name ng.docs.vm.com angular.docs.vm.com ng.vm.jdunk.co ng.docs.vm.jdunk.co;

    access_log /var/log/nginx/ng.docs.vm.com.access.log;
    error_log /var/log/nginx/ng.docs.vm.com.error.log;

    root /var/www/ng.docs.vm.com;
