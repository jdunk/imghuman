server {
    ...
    server_name laravel.docs.vm.com lvl.docs.vm.com lrvl.docs.vm.com laravel.docs.vm.jdunk.co laravel.vm.jdunk.co;

    access_log /var/log/nginx/laravel.docs.vm.com.access.log;
    error_log /var/log/nginx/laravel.docs.vm.com.error.log;

    root /var/www/laravel.docs.vm.com;
